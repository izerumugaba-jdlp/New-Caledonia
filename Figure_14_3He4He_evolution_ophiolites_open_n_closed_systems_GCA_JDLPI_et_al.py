...
# saving the figure
plt.savefig('Figure_14_3He4He_evolution_ophiolites_open_n_closed_systems_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_14_3He4He_evolution_ophiolites_open_n_closed_systems_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
