...
plt.annotate("B", xy=(-87, 39), xytext=(0, 0), ha='center', va='top', textcoords='offset points', fontsize= 20, fontweight= "bold", zorder=6)
    
plt.savefig('Figure_9_B_d13C(CH4)_vs_d13C(CO2)_NewCaledonia_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_9_B_d13C(CH4)_vs_d13C(CO2)_NewCaledonia_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')    
