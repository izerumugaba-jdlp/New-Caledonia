...
# Importing files
dfdata= pd.read_excel(r"Compilation_rawdata_NC_2019_2020_2022.xlsx", index_col= "IDss")  
dflitdata= pd.read_excel(r"Literaturedata.xlsx", sheet_name="Serpent.Contexts_plot", index_col="Sample")
                         
# dfendmembers= pd.read_excel(r"E:\Documents\DOCS_msi\PhD@UniPau\ACADEMICS\python_phD\endmembers.xlsx")
...
# plotting the data 
Northern_sites= ax.scatter(dfdata_North["4He/20Ne"], dfdata_North["R/Ra"], marker= "D", s=50, color= "brown", label="Basement sites", zorder= 5)
Southern_sites= ax.scatter(dfdata_South["4He/20Ne"], dfdata_South["R/Ra"], marker= "D", s=50, color= "forestgreen", label="Ophiolitic sites", zorder= 5)
...
# ax.scatter(dflitdata["4He/20Ne"], dflitdata["R/Ra"], marker="o", s=35, color= "grey", label= "Ophiolites (literature)", zorder= 4)
...
f_m_cm= [i/100 for i in [6, 12, 25]]                   # fraction of mantle in mantle-crust mixture  #62% for 5Ra
...
ax.annotate("0.02Ra", xy=(6*10**2, 0.027), xytext=(0,0), textcoords='offset points', color= 'black')
ax.annotate("Crust", xy=(6*10**2, 0.012), xytext=(0,0), textcoords='offset points', color= 'black')
ax.annotate("0.5Ra (6%)", xy=(3.5*10**2, 0.55), xytext=(0,0), textcoords='offset points', color= 'black')
ax.annotate("1Ra (Air)", xy=(3.5*10**2, 1.15), xytext=(0, 0), textcoords='offset points', color= 'black')
ax.annotate("Air", xy=(0.25, 0.5), xytext=(-13, 20), textcoords='offset points', color= 'black')
ax.annotate("2Ra (25%)", xy=(3.5*10**2, 2.25), xytext=(0, 0), textcoords='offset points', color= 'black')
...
plt.savefig('Figure_6_4He20Ne_vs_3He4He_NewCaledonia_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_6_4He20Ne_vs_3He4He_NewCaledonia_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
