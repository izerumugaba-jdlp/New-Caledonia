...
dfendmembers = pd.read_excel(r"endmembers.xlsx", index_col=("Environment"))
...
cbar1.set_label("$\mathbf{δ^{13}C(CH_4)}$ (‰ VPDB)", fontweight='bold', fontsize=11)
...
plt.savefig("Figure_8_CH4_vs_H2_vs_d13C(CH4)_NewCaledonia_GCA_JDLPI_et_al.svg", format= "svg", bbox_inches='tight')
plt.savefig("Figure_8_CH4_vs_H2_vs_d13C(CH4)_NewCaledonia_GCA_JDLPI_et_al.tiff", format= "tiff", bbox_inches='tight')
