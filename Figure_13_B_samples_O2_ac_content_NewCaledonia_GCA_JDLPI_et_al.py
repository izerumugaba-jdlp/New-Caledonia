...
dfdataNC= pd.read_excel(r"Gasdata_NC_AirCorrected.xlsx") 
...
# Show the plot
plt.savefig("Figure_13_B_samples_O2_ac_content_NewCaledonia_GCA_JDLPI_et_al.svg", format= "svg", bbox_inches='tight')
plt.savefig("Figure_13_B_samples_O2_ac_content_NewCaledonia_GCA_JDLPI_et_al.tiff", format= "tiff", bbox_inches='tight')
