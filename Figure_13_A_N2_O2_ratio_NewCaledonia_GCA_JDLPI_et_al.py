...
dfdataNC= pd.read_excel(r"Compilation_rawdata_NC_2019_2020_2022.xlsx", sheet_name= "dataraw_ordered")   
...
plt.annotate("A", xy=(0, 24), xytext=(0, 0), ha='center', va='top', textcoords='offset points', fontsize= 20, fontweight= "bold", zorder=6)

# saving the plot
plt.savefig("Figure_13_A_N2_O2_ratio_NewCaledonia_GCA_JDLPI_et_al.svg", format= "svg", bbox_inches='tight')
plt.savefig("Figure_13_A_N2_O2_ratio_NewCaledonia_GCA_JDLPI_et_al.tiff", format= "tiff", bbox_inches='tight')
