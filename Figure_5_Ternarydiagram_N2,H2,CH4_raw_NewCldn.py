...
dfmajorsNC = pd.read_excel(r"Compilation_rawdata_NC_2019_2020_2022.xlsx", sheet_name= "dataraw_ordered")
...
plt.savefig("Figure_5_Ternarydiagram_N2,H2,CH4_raw_NewCldn.svg", format='svg', bbox_inches='tight')
plt.savefig("Figure_5_Ternarydiagram_N2,H2,CH4_raw_NewCldn.tiff", format='tiff', bbox_inches='tight')
