...
# 36Ar vs 84Kr (Endmembers are from Vacquand et al., 2018; Wang et al., 2022)
...
plt.annotate("A", xy=(1.4e-07, 8e-05), xytext=(0, 0), ha='center', va='top', textcoords='offset points', fontsize= 20, fontweight= "bold", zorder=6)

plt.legend(loc= 'lower right')

# saving the figure
plt.savefig('Figure_12_A_36Ar_vs_84Kr_NewCaledonia_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_12_A_36Ar_vs_84Kr_NewCaledonia_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
