...
"""
plt.annotate("A", xy=(6.3, 1090), xytext=(0, 0), ha='center', va='top', 
             textcoords='offset points', fontsize= 20, fontweight= "bold", zorder=6)

plt.savefig('Figure_3_A_pH_vs_Eh_NewCaledonia_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_3_A_pH_vs_Eh_NewCaledonia_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
