...
plt.savefig("Figure_9_A_CH4_vs_CO2_d13C(CH4)_ NewCaledonia_GCA_JDLPI_et_al.svg", format= "svg", bbox_inches='tight')
plt.savefig("Figure_9_A_CH4_vs_CO2_d13C(CH4)_ NewCaledonia_GCA_JDLPI_et_al.tiff", format= "tiff", bbox_inches='tight')
