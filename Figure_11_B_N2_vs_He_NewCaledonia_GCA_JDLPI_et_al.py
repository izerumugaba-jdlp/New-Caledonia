...
plt.savefig('Figure-11_B_N2_vs_He_NewCaledonia_GCA_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure-11_B_N2_vs_He_NewCaledonia_GCA_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
